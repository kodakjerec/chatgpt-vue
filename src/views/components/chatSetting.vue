<template>
    <div>
        <div class="fixed left-0 top-0 z-1000 w-full h-full overflow-x-hidden overflow-y-auto bg-slate-100 opacity-90" @click="clickWhiteSpace">

            <div class="relative top-10 w-full text-center px-6">
                    ...
                    <div id="model_content" class="flex flex-wrap rounded m-2">
                        ...
                        <div class="w-full border-t mt-2 pt-2">
                            <label for="temperature" class="text-gray-700 mb2 flex items-center">
                                ...
                                <input v-model="settings_chat.temperature" class="input w-1/2" type="range" step=".1" placeholder="0 to 2" :min="0" :max="2" @change="$event => contentInputChange($event, 'settings_chat')" />
                            </label>
                        ...
                        <div class="w-full border-t mt-2 pt-2">
                            <label for="presence_penalty" class="text-gray-700 mb2 flex items-center">
                                ...
                                <input v-model="settings_chat.presence_penalty" class="input w-1/2" type="range" step=".1" placeholder="-2 to 2" :min="-2" :max="2" @change="$event => contentInputChange($event, 'settings_chat')" />
                            </label>
                        ...
                        <div class="w-full border-t mt-2 pt-2">
                            <label for="frequency_penalty" class="text-gray-700 mb2 flex items-center">
                                ...
                                <input v-model="settings_chat.frequency_penalty" class="input w-1/2" type="range" step=".1" placeholder="-2 to 2" :min="-2" :max="2" @change="$event => contentInputChange($event, 'settings_chat')" />
                            </label>
